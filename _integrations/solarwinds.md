...
2. Extract the archive and open a terminal with a command prompt in the extracted directory.
   ...
   **Note:** BigPanda recommends running the integration utility locally on the SolarWinds server. Alternatively, make sure there are no firewalls blocking access to TCP port `17778`. For more troubleshooting tips, see [our documentation](https://docs.bigpanda.io/docs/solarwinds).
